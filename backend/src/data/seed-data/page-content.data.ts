export const pageContents = [
  {
    ...
    title: 'Promise',
    content: 'The Promise object represents the eventual completion (or failure) of an asynchronous operation and its resulting value.',
  },
  {
    pageId: '76e9d529-a303-41c5-86e4-e2c54985b373',
    authorId: '9a25ad37-a647-4c1a-897f-59dbf275765d',
    title: 'Map',
    content: 'he Map object holds key-value pairs and remembers the original insertion order of the keys. Any value (both objects and primitive values) may be used as either a key or a value.',
  },
  {
    pageId: 'c204715d-1164-46d7-aadd-bf15721bbda8',
    authorId: '9a25ad37-a647-4c1a-897f-59dbf275765d',
    title: 'Error',
    content: 'Error objects are thrown when runtime errors occur. The Error object can also be used as a base object for user-defined exceptions. See below for standard built-in error types.',
  },
  {
  ...
  },
  {
    ...
    authorId: '9a25ad37-a647-4c1a-897f-59dbf275765d',
    title: 'Array',
    content: 'The JavaScript Array class is a global object that is used in the construction of arrays; which are high-level, list-like objects.',
  },
  {
    pageId: '2a62f642-e499-4779-b415-7297fe716578',
    authorId: '9a25ad37-a647-4c1a-897f-59dbf275765d',
    title: 'Set',
    content: 'The Set object lets you store unique values of any type, whether primitive values or object references.',
  },
  {
    pageId: 'e0e4c236-c208-46b4-acf3-4973ad805bb7',
    authorId: '9a25ad37-a647-4c1a-897f-59dbf275765d',
    title: 'Generator',
    content: 'The Generator object is returned by a generator function and it conforms to both the iterable protocol and the iterator protocol.',
  },
  {
    pageId: '22c9bbd0-20a7-4e22-9f0c-f74df23c39ed',
    authorId: '9a25ad37-a647-4c1a-897f-59dbf275765d',
    title: 'Proxy',
    content: 'The Proxy object enables you to create a proxy for another object, which can intercept and redefine fundamental operations for that object.',
  },
  {
