...
export class createDraftTable1629493728634 implements MigrationInterface {
  name = 'createDraftTable1629493728634';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE TABLE "draft" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "title" character varying NOT NULL, "content" character varying NOT NULL, "pageId" character varying NOT NULL, CONSTRAINT "UQ_4cd6d3e3472858e7e27a7263cb0" UNIQUE ("pageId"), CONSTRAINT "PK_0b2b03d3f2c998450423648bc65" PRIMARY KEY ("id"))',
    );
    await queryRunner.query(
