...
export class addTables1627547680626 implements MigrationInterface {
  name = 'addTables1627547680626';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE "team_member" ("userId" character varying NOT NULL, "teamId" character varying NOT NULL, CONSTRAINT "PK_bd2b3ef7569d75642e091853771" PRIMARY KEY ("userId", "teamId"))');
    await queryRunner.query('CREATE TYPE "team_permission_option_enum" AS ENUM(\'read\', \'write\', \'admin\')');
    await queryRunner.query('CREATE TABLE "team_permission" ("teamId" character varying NOT NULL, "pageId" character varying NOT NULL, "option" "team_permission_option_enum" NOT NULL DEFAULT \'read\', CONSTRAINT "PK_2228dc613c3b121533089d3fc47" PRIMARY KEY ("teamId", "pageId"))');
    ...
    await queryRunner.query('CREATE TABLE "page_tag" ("tagId" character varying NOT NULL, "pageId" character varying NOT NULL, CONSTRAINT "PK_304d2445cb4945352663af8b46e" PRIMARY KEY ("tagId", "pageId"))');
    ...
    await queryRunner.query('CREATE TABLE "user_workspace" ("workspaceId" character varying NOT NULL, "userId" character varying NOT NULL, "role" "user_workspace_role_enum" NOT NULL DEFAULT \'user\', CONSTRAINT "PK_c395920dbb9ba8840eaa0278bf8" PRIMARY KEY ("workspaceId", "userId"))');
    await queryRunner.query('CREATE TYPE "user_permission_option_enum" AS ENUM(\'read\', \'write\', \'admin\')');
    await queryRunner.query('CREATE TABLE "user_permission" ("userId" character varying NOT NULL, "pageId" character varying NOT NULL, "option" "user_permission_option_enum" NOT NULL DEFAULT \'read\', CONSTRAINT "PK_c0f3fe7d55775ca79ee3be65910" PRIMARY KEY ("userId", "pageId"))');
